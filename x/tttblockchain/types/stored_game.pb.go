...
// source: tttblockchain/stored_game.proto
...
type StoredGame struct {
	...
	Cross  string `protobuf:"bytes,4,opt,name=cross,proto3" json:"cross,omitempty"`
	Circle string `protobuf:"bytes,5,opt,name=circle,proto3" json:"circle,omitempty"`
}
...
func (*StoredGame) Descriptor() ([]byte, []int) {
	return fileDescriptor_555b185e48c099ba, []int{0}
}
...
func (m *StoredGame) GetCross() string {
	if m != nil {
		return m.Cross
	}
	return ""
...
func (m *StoredGame) GetCircle() string {
	if m != nil {
		return m.Circle
	}
	return ""
...
func init() {
	proto.RegisterType((*StoredGame)(nil), "mesorem.ttt_blockchain.tttblockchain.StoredGame")
}

func init() { proto.RegisterFile("tttblockchain/stored_game.proto", fileDescriptor_555b185e48c099ba) }

var fileDescriptor_555b185e48c099ba = []byte{
	// 222 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *StoredGame) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Circle) > 0 {
		...
		i = encodeVarintStoredGame(dAtA, i, uint64(len(m.Circle)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Cross) > 0 {
		i -= len(m.Cross)
		copy(dAtA[i:], m.Cross)
		i = encodeVarintStoredGame(dAtA, i, uint64(len(m.Cross)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Turn) > 0 {
