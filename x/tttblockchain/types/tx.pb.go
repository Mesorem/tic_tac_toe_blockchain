...
type MsgCreateGame struct {
	...
	Cross   string `protobuf:"bytes,2,opt,name=cross,proto3" json:"cross,omitempty"`
	Circle  string `protobuf:"bytes,3,opt,name=circle,proto3" json:"circle,omitempty"`
}
...
func (*MsgCreateGame) Descriptor() ([]byte, []int) {
	return fileDescriptor_eef2cdfb8566a12d, []int{0}
}
...
func (m *MsgCreateGame) GetCross() string {
	if m != nil {
		return m.Cross
	}
	return ""
...
func (m *MsgCreateGame) GetCircle() string {
	if m != nil {
		return m.Circle
	}
	return ""
...
func (*MsgCreateGameResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_eef2cdfb8566a12d, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgCreateGame)(nil), "mesorem.ttt_blockchain.tttblockchain.MsgCreateGame")
	proto.RegisterType((*MsgCreateGameResponse)(nil), "mesorem.ttt_blockchain.tttblockchain.MsgCreateGameResponse")
}

func init() { proto.RegisterFile("tttblockchain/tx.proto", fileDescriptor_eef2cdfb8566a12d) }

var fileDescriptor_eef2cdfb8566a12d = []byte{
	// 254 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *msgClient) CreateGame(ctx context.Context, in *MsgCreateGame, opts ...grpc.CallOption) (*MsgCreateGameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mesorem.ttt_blockchain.tttblockchain.Msg/CreateGame", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateGame_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mesorem.ttt_blockchain.tttblockchain.Msg/CreateGame",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mesorem.ttt_blockchain.tttblockchain.Msg",
	...
	Metadata: "tttblockchain/tx.proto",
}
...
func (m *MsgCreateGame) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Circle) > 0 {
		i -= len(m.Circle)
		copy(dAtA[i:], m.Circle)
		i = encodeVarintTx(dAtA, i, uint64(len(m.Circle)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Cross) > 0 {
		i -= len(m.Cross)
		copy(dAtA[i:], m.Cross)
		i = encodeVarintTx(dAtA, i, uint64(len(m.Cross)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Creator) > 0 {
...
func (m *MsgCreateGame) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Cross = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.Circle = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
